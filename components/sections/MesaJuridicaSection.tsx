...
export function MesaJuridicaSection({ onOpenDemo }: MesaJuridicaSectionProps = {}) {
  ...
  return (
    <SectionWrapper id="recursos" className="border-t border-[#E2E8F0]/70 bg-white/70" spacing="default">
          ...
          <div className="rounded-2xl border border-[#E2E8F0] bg-white shadow-card overflow-hidden">
            ...
            <div className="h-10 px-4 bg-[#F8F9FA] border-b border-[#E2E8F0] flex items-center justify-between text-xs font-mono text-[#475569]">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <span className="text-[11px] text-emerald-800 bg-emerald-50 px-2.5 py-0.5 rounded border border-emerald-200 font-medium">
                  OCR Ativo
                </span>
              </div>
            </div>
            ...
            <div className="p-5 sm:p-6 space-y-4 bg-slate-50/50">
              <div className="p-4 sm:p-5 bg-white rounded-xl border border-slate-200 space-y-3 shadow-xs">
                ...
                <div className="flex items-center justify-between text-[11px] text-slate-500 pt-1">
                  ...
                  <span className="text-[#0F2B48] font-semibold hover:underline cursor-pointer">Usar na Réplica →</span>
                </div>
              </div>

              {/* Second Extracted Card */}
              <div className="p-4 sm:p-5 bg-white rounded-xl border border-slate-200 space-y-2.5 shadow-xs">
                <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                  <span className="text-xs font-semibold text-[#0F172A]">
                ...
                <div className="flex items-center justify-between text-[11px] text-slate-500 pt-1">
                  ...
                  <span className="text-[#0F2B48] font-semibold hover:underline cursor-pointer">Usar na Minuta →</span>
                </div>
              </div>
            </div>
          </div>
